...
public class GetAllStreamTagsResponse extends TwitchApiResponse<GetAllStreamTagsResponse> {
	...
	public String toString() {
		return "GetAllStreamTagsResponse{" + "tagID='" + tagID + '\'' + ", isAuto=" + isAuto + ", localizedNames=" + localizedNames + ", localizedDescriptions=" + localizedDescriptions + '}';
	}
}